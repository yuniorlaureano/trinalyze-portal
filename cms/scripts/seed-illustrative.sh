...
put_single /api/home-page '{"data":{
  ...
  "queHacemos":{"eyebrow":"Qué hacemos","heading":"Consultoría tecnológica con base en datos, no en suposiciones.","body":"TRINALYZE es una firma dominicana de consultoría tecnológica, desarrollo de software, inteligencia artificial y business intelligence. Ayudamos a organizaciones a diagnosticar procesos ineficientes, construir la infraestructura de datos que les falta, y automatizar lo que hoy hacen a mano.\n\nOperamos con un modelo matricial: equipos multidisciplinarios de consultores, desarrolladores, analistas y científicos de datos se arman por proyecto según lo que cada iniciativa realmente necesita.","stats":[{"value":"Santo Domingo, RD","label":"Sede central"},{"value":"7","label":"Líneas de negocio activas"}]},
...
put_single /api/equipo-page '{"data":{
  ...
  "filosofia":{"eyebrow":"Filosofía","heading":"Colaboración transversal.","body":"Ningún proyecto se resuelve desde una sola disciplina. Consultores, desarrolladores, analistas y científicos de datos trabajan juntos desde el diagnóstico hasta la implementación.\n\nEs de suma importancia la participación de todos los colaboradores: cada dirección aporta su mirada antes de que una solución se dé por terminada."},
  "publishedAt":"2026-08-27T00:00:00.000Z"
}}'
