...
export interface ApiContactSubmissionContactSubmission
  ...
  info: {
    description: "Entry sent from the 'Solicitar diagnostico' form";
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Insights blog post';
    displayName: 'Post';
    pluralName: 'posts';
    singularName: 'post';
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Case study in problem / solution / result format';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isIllustrative: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::project.project'
    ...
    sector: Schema.Attribute.Enumeration<
      ['Hospitalidad', 'PYMEs', 'Retail', 'Finanzas', 'Educacion']
    > &
      Schema.Attribute.Required;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiSectorSector extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Industry sector TRINALYZE works with';
    displayName: 'Sector';
    pluralName: 'sectors';
    singularName: 'sector';
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'One of the three service pillars TRINALYZE offers';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    ...
    pillar: Schema.Attribute.Enumeration<
      ['Data & Analytics', 'Technology', 'AI & Automation']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'CEO or director shown on the Equipo page';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    roleSummary: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
